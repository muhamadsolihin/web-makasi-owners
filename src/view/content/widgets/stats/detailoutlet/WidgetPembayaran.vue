    ...
    <div class="card card-custom mb-5 mb-xxl-8">
      ...
      <div class="card-body">
        ...
        <div class="d-flex align-items-center">
            ...
            <span class="symbol-label" style="background-color: #F1FAFF">
              <span class="svg-icon svg-icon-2x svg-icon-success">
                <i
                  ...
                  style="font-size: 3rem; color: #0098DA"
                ></i>
              </span>
            </span>
          </div>
          ...
          <!--begin::Title-->
          <div>
            <a href="#" class="fs-4.5 text-gray-800 fw-bolder" style="width:250px">Metode Pembayaran</a>
            ...
            <div class="col">
              <el-button
                id="detail"
                @click="$router.push(`/outlets/outlet/payment-methods`)"
