<template>
  ...
  <div class="pt-10">
    ...
    <div class="py-5">
      Use
      <a
        href="<?php echo Theme::getPageUrl('documentation/icons/duotone')?>"
        class="fw-bold"
        >Duotone Svg Icons</a
    ...
    <div class="py-5">
      Use
      <a
        href="<?php echo Theme::getPageUrl('documentation/icons/font-awesome')?>"
        class="fw-bold"
    ...
    <div class="py-5">
      Use
      <a
        href="<?php echo Theme::getPageUrl('documentation/icons/line-awesome')?>"
        class="fw-bold"
