  ...
  <div class="rounded border border-1 p-2">
    ...
    >
      <el-table-column
        ...
        sortable
      ></el-table-column>
      <el-table-column prop="fee_trx" label="Biaya (Rp)" align="right" width="80px" sortable>
        <template #default="scope">
          {{ formatCurrency(scope.row.fee_trx) }}
        </template>
      </el-table-column>
      <el-table-column prop="subsidy_fee" label="Subsidi (Rp)" align="right" width="80px" sortable>
        <template #default="scope">
